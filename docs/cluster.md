...
`cluster.get_servers()` - function to get connections to all cluster servers,
...
`cluster.get_masters()` - function to get connections to master instances of all replicasets,

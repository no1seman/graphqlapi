...
Submodule `middleware.lua` is a part of GraphQL API module that provide two simple stub triggers that may be used in some simple non Tarantool Cartrdige Applications to make module work from the box. In real non Tarantool Cartridge application these stubs must be replaced with any desired logic.
